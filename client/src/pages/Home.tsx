        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14">
          ...
          <div className="lg:col-span-5 space-y-10">
            ...
            <div>
              ...
              {/* Floating Stat metrics on black with Emerald Green accents */}
              <div className="p-6 rounded-3xl bg-white/[0.02] border border-white/[0.08] flex justify-between text-center divide-x divide-white/[0.08]">
                ...
                <div className="px-2 w-1/3">
                  ...
                  <div className="text-2xl font-normal text-[#15846e] tracking-tight">3</div>
                </div>
                <div className="px-2 w-1/3">
            ...
            <div className="flex items-center justify-center py-10 relative">
               ...
               >
                 <div className="w-12 h-12 bg-white/[0.04] border border-white/10 rounded-full text-[#ffffff] flex items-center justify-center mb-3 hover:border-[#15846e]/60 transition-colors">
            ...
            <div className="p-6 rounded-3xl bg-white/[0.02] border border-white/[0.08]">
               ...
               <div className="space-y-2 mb-6">
                 ...
                 <ul className="text-xs font-light text-[#ffffff] space-y-1.5">
                   <li className="flex items-center"><span className="w-1.5 h-1.5 rounded-full bg-[#15846e] mr-2.5"></span> Atenolol 25mg • Morning</li>
                   <li className="flex items-center"><span className="w-1.5 h-1.5 rounded-full bg-[#15846e] mr-2.5"></span> Paracetamol 650mg • As Needed</li>
                   <li className="flex items-center"><span className="w-1.5 h-1.5 rounded-full bg-[#15846e] mr-2.5"></span> Vitamin B Complex • Afternoon</li>
                 </ul>
               </div>

               <button 
                 onClick={() => openUploadModal('prescriptions')}
                 className="w-full bg-[#15846e]/10 hover:bg-[#15846e]/20 text-[#15846e] border border-[#15846e]/30 py-3 rounded-full font-semibold transition-all text-xs uppercase tracking-wider active:scale-[0.98]"
               >
          ...
          <div id="timeline" className="lg:col-span-4 relative">
            ...
            <div className="space-y-8 relative z-10 pl-16">
              ...
              <div className="relative">
                ...
                <div 
                  className="p-5 rounded-2xl bg-white/[0.02] border border-white/[0.08] hover:border-[#15846e]/50 transition-all cursor-pointer group"
                  onClick={() => navigate('/dashboard')}
                >
                   <div className="flex items-center space-x-3 mb-2">
                     <div className="w-2 h-2 rounded-full bg-[#15846e]"></div>
                     <div className="font-normal text-sm text-[#ffffff] group-hover:text-[#15846e] transition-colors">CBC & Metabolic Panel</div>
                   </div>
              ...
              <div className="relative">
                ...
                >
                   <div className="flex items-center space-x-3 mb-2">
                     <div className="w-2 h-2 rounded-full bg-[#15846e]"></div>
                     <div className="font-normal text-sm text-[#ffffff] group-hover:text-[#15846e] transition-colors">Cardiology Prescription</div>
                   </div>
              ...
              <div className="relative">
                ...
                >
                   <div className="flex items-center space-x-3 mb-2">
                     <div className="w-2 h-2 rounded-full bg-[#15846e]"></div>
                     <div className="font-normal text-sm text-[#ffffff] group-hover:text-[#15846e] transition-colors">Radiology Scan Assessment</div>
                   </div>
