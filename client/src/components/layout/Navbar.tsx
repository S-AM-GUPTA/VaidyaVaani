      ...
      <div className="max-w-[1280px] mx-auto px-6 lg:px-12">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center space-x-9">
            {isAuthenticated ? (
              <>
                <Link to="/home" className="text-xs uppercase font-semibold tracking-[0.05em] text-[#ffffff] hover:text-[#00d2d3] transition-colors">
                  Workspace
                </Link>
            ...
            {isAuthenticated ? (
              <div className="flex items-center space-x-5">
                ...
                <button className="text-[#9a9a9a] hover:text-[#ffffff] relative transition-colors">
                  ...
                  <span className="absolute -top-0.5 -right-0.5 w-2 h-2 bg-[#00d2d3] rounded-full"></span>
                </button>
              </div>
            ) : (
              <div className="flex items-center space-x-4">
                ...
                <button 
                  ...
                  className="bg-[#8052ff] hover:bg-[#6c3df5] text-white px-5 py-2.5 rounded-full text-xs font-semibold uppercase tracking-[0.025em] transition-all duration-200 active:scale-[0.98] shadow-[0_0_20px_rgba(128,82,255,0.3)]"
                >
                  Request Access
                </button>
              </div>
